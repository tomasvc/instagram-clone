    ...
    return (
        <div className="post">
            <div className="post__header">
                ...
                <svg className="post__more" aria-label="like" fill="#262626" height="16" viewBox="0 0 48 48" width="16">
            ...
            <div className="post__buttons">
                <svg className="post__like" aria-label="like" fill="#262626" height="24" viewBox="0 0 48 48" width="24">
                    <path id="post__likePath" d="M34.6 6.1c5.7 0 10.4 5.2 10.4 11.5 0 6.8-5.9 11-11.5 16S25 
            ...
            <div className="post__comments">
                {comments.map((comment) => {
                    ...
                    <p className="post__comment">
                        ...
                        <svg className="comment__like" aria-label="like" fill="#262626" height="12" viewBox="0 0 48 48" width="12">
