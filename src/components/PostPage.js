            ...
            <div className="postPage__main">
                ...
                <div className="main__right">
                    <div className="right__header">
                        <a href={'/' + post?.username}><Avatar className="header__avatar" src={userData?.avatarUrl}></Avatar></a>
                        <a href={'/' + post?.username}><h3 className="header__username">{post?.username}</h3></a>
                    </div>
                    <div className="right__content">
                        <div className="content__avatar">
                            <a href={'/' + post?.username}><Avatar className="avatar__avatar" src={userData?.avatarUrl}></Avatar></a>
                        </div>
                    ...
                    <div className="right__bottom">
                        ...
                        <p className="bottom__likes">{likes?.length} likes</p>
